...
const file_proto_user_user_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id2\xe1\x02\n" +
	"\vUserService\x128\n" +
...
var file_proto_user_user_proto_depIdxs = []int32{
	...
	7, // 1: user.UserService.Ping:input_type -> google.protobuf.Empty
	...
	7, // 7: user.UserService.Ping:output_type -> google.protobuf.Empty
	0, // 8: user.UserService.CreateUser:output_type -> user.User
	0, // 9: user.UserService.GetUser:output_type -> user.User
	4, // 10: user.UserService.ListUsers:output_type -> user.ListUsersResponse
