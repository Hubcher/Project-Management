...
func (c *userServiceClient) Ping(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
...
func (UnimplementedUserServiceServer) Ping(context.Context, *empty.Empty) (*empty.Empty, error) {
