...
func (c *authServiceClient) Ping(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
...
func (UnimplementedAuthServiceServer) Ping(context.Context, *empty.Empty) (*empty.Empty, error) {
