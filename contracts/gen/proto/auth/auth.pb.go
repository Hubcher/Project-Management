...
const file_proto_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x15proto/auth/auth.proto\x12\x04auth\x1a\x1bgoogle/protobuf/empty.proto2G\n" +
	"\vAuthService\x128\n" +
	"\x04Ping\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x00B<Z:github.com/Hubcher/project-management/contracts/gen/authpbb\x06proto3"
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	0, // 0: auth.AuthService.Ping:input_type -> google.protobuf.Empty
	0, // 1: auth.AuthService.Ping:output_type -> google.protobuf.Empty
